...
public class NewPlayer : PhysicsObject
{
    ...
    public float speedMultiplier; //How much should we multiply the speed by? (Used for speeding up the player from I Am Speed)
    public float speedInverter = 1;
    ...
    void Start()
    {
        ...
        //Set up movement characteristics that memes change
        speedMultiplier = 1;
        speedInverter = 1;
        ticksSinceClone = 0;
    }
    ...
    protected void ComputeVelocity()
    {
        ...
        if (!frozen)
        {
            move.x = (Input.GetAxis("Horizontal") + launch) * speedMultiplier;
            move.x *= speedInverter;
    ...
    public void GetHurt(int hurtDirection, int hitPower, GameObject o)
    {
    ...
    public IEnumerator Die(GameObject o)
    {
